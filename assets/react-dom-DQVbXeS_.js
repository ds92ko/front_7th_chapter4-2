import { b as __commonJS, f as __toESM } from "./rolldown-runtime-CINmCwk_.js";
import { a1 as require_react } from "./chakra-ui-YFQdXzg5.js";
import { Q as require_react_dom } from "./react-BDq5ydJY.js";
import { b as HiddenText, c as LiveRegion, d as useAnnouncement, f as add, g as canUseDOM, h as findFirstFocusableNode, i as getEventCoordinates, j as getOwnerDocument, k as getWindow, l as isDocument, m as isHTMLElement, n as isKeyboardEvent, o as isNode, p as isSVGElement, q as isWindow, r as subtract, s as useEvent, t as useInterval, u as useIsomorphicLayoutEffect, v as useLatestValue, w as useLazyMemo, x as useNodeRef, y as usePrevious, z as useUniqueId } from "./dnd-kit-BdY5nInc.js";
...
var require_react_dom_client_production = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/react-dom@19.1.1_react@19.1.1/node_modules/react-dom/cjs/react-dom-client.production.js": ((exports) => {
	var Scheduler = require_scheduler(), React$1 = require_react(), ReactDOM = require_react_dom();
	...
	function createCursor(defaultValue$3) {
		return { current: defaultValue$3 };
	}
	function pop(cursor) {
	...
	function markRootEntangled(root$1, entangledLanes) {
		...
		for (root$1 = root$1.entanglements; rootEntangledLanes;) {
			...
			lane & entangledLanes | root$1[index$6] & entangledLanes && (root$1[index$6] |= entangledLanes);
	...
	function updateInput(element, value, defaultValue$3, lastDefaultValue, checked, defaultChecked, type, name) {
		element.name = "";
		...
		null != value ? setDefaultValue(element, type, getToStringValue(value)) : null != defaultValue$3 ? setDefaultValue(element, type, getToStringValue(defaultValue$3)) : null != lastDefaultValue && element.removeAttribute("value");
		null == checked && null != defaultChecked && (element.defaultChecked = !!defaultChecked);
		null != checked && (element.checked = checked && "function" !== typeof checked && "symbol" !== typeof checked);
		null != name && "function" !== typeof name && "symbol" !== typeof name && "boolean" !== typeof name ? element.name = "" + getToStringValue(name) : element.removeAttribute("name");
	}
	function initInput(element, value, defaultValue$3, checked, defaultChecked, type, name, isHydrating$1) {
		null != type && "function" !== typeof type && "symbol" !== typeof type && "boolean" !== typeof type && (element.type = type);
		if (null != value || null != defaultValue$3) {
			if (!("submit" !== type && "reset" !== type || void 0 !== value && null !== value)) return;
			defaultValue$3 = null != defaultValue$3 ? "" + getToStringValue(defaultValue$3) : "";
			value = null != value ? "" + getToStringValue(value) : defaultValue$3;
	...
	function updateTextarea(element, value, defaultValue$3) {
		if (null != value && (value = "" + getToStringValue(value), value !== element.value && (element.value = value), null == defaultValue$3)) {
			element.defaultValue !== value && (element.defaultValue = value);
			return;
		}
		element.defaultValue = null != defaultValue$3 ? "" + getToStringValue(defaultValue$3) : "";
	}
	function initTextarea(element, value, defaultValue$3, children) {
		if (null == value) {
			if (null != children) {
				if (null != defaultValue$3) throw Error(formatProdErrorMessage(92));
				if (isArrayImpl(children)) {
					if (1 < children.length) throw Error(formatProdErrorMessage(93));
					children = children[0];
				}
				defaultValue$3 = children;
			}
			defaultValue$3 ??= "";
			value = defaultValue$3;
		}
		defaultValue$3 = getToStringValue(value);
		element.defaultValue = defaultValue$3;
		children = element.textContent;
		children === defaultValue$3 && "" !== children && null !== children && (element.value = children);
	}
	...
	var canUseDOM$1 = !("undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement), passiveBrowserEventsSupported = !1;
	if (canUseDOM$1) try {
		var options = {};
	...
	var KeyboardEventInterface = assign({}, UIEventInterface, {
		...
		27,
		32
	], canUseCompositionEvent = canUseDOM$1 && "CompositionEvent" in window, documentMode = null;
	canUseDOM$1 && "documentMode" in document && (documentMode = document.documentMode);
	var canUseTextInputEvent = canUseDOM$1 && "TextEvent" in window && !documentMode, useFallbackCompositionData = canUseDOM$1 && (!canUseCompositionEvent || documentMode && 8 < documentMode && 11 >= documentMode), SPACEBAR_CHAR = String.fromCharCode(32), hasSpaceKeypress = !1;
	...
	var skipSelectionChangeEvent = canUseDOM$1 && "documentMode" in document && 11 >= document.documentMode, activeElement = null, activeElementInst = null, lastSelection = null, mouseDown = !1;
	...
	function trackUsedThenable(thenableState$2, thenable, index$1) {
		...
		void 0 === index$1 ? thenableState$2.push(thenable) : index$1 !== thenable && (thenable.then(noop$3, noop$3), thenable = index$1);
	...
	function useThenable(thenable) {
		...
		thenable = trackUsedThenable(thenableState$1, thenable, index$1);
	...
	function updateReducer(reducer$1) {
		...
		return updateReducerImpl(hook, currentHook, reducer$1);
	}
	function updateReducerImpl(hook, current, reducer$1) {
		...
		if (null === baseQueue) hook.memoizedState = pendingQueue;
			...
			if (!objectIs(pendingQueue, hook.memoizedState) && (didReceiveUpdate = !0, didReadFromEntangledAsyncAction$32 && (reducer$1 = currentEntangledActionThenable, null !== reducer$1))) throw reducer$1;
	...
	function updateOptimisticImpl(hook, current, passthrough, reducer$1) {
	...
	var ContextOnlyDispatcher = {
		...
		useOptimistic: function(passthrough, reducer$1) {
			var hook = updateWorkInProgressHook();
			return updateOptimisticImpl(hook, currentHook, passthrough, reducer$1);
		},
		useMemoCache,
	...
	function unwrapThenable(thenable) {
		...
		return trackUsedThenable(thenableState, thenable, index$1);
	}
	...
	function updateSuspenseComponent(current, workInProgress$1, renderLanes$1) {
			...
			if (isHydrating) {
				...
				if (isHydrating) {
					...
					if (JSCompiler_temp$jscomp$0 = nextInstance) {
						...
						null !== nextInstance ? (workInProgress$1.memoizedState = {
		...
		if (null !== JSCompiler_temp$jscomp$0 && (nextInstance = JSCompiler_temp$jscomp$0.dehydrated, null !== nextInstance)) {
			if (didSuspend) workInProgress$1.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress$1), workInProgress$1.flags &= -257, workInProgress$1 = retrySuspenseComponentWithoutHydrating(current, workInProgress$1, renderLanes$1)) : null !== workInProgress$1.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress$1), workInProgress$1.child = current.child, workInProgress$1.flags |= 128, workInProgress$1 = null) : (reuseSuspenseHandlerOnStack(workInProgress$1), showFallback = nextProps.fallback, nextInstance = workInProgress$1.mode, nextProps = mountWorkInProgressOffscreenFiber({
				...
				workInProgress$1 = retrySuspenseComponentWithoutHydrating(current, workInProgress$1, renderLanes$1);
			} else "$?" === nextInstance.data ? (workInProgress$1.flags |= 192, workInProgress$1.child = current.child, workInProgress$1 = null) : (current = JSCompiler_temp$jscomp$0.treeContext, nextHydratableInstance = getNextHydratable(nextInstance.nextSibling), hydrationParentFiber = workInProgress$1, isHydrating = !0, hydrationErrors = null, rootOrSingletonContext = !1, null !== current && (idStack[idStackIndex++] = treeContextId, idStack[idStackIndex++] = treeContextOverflow, idStack[idStackIndex++] = treeContextProvider, treeContextId = current.id, treeContextOverflow = current.overflow, treeContextProvider = workInProgress$1), workInProgress$1 = mountSuspensePrimaryChildren(workInProgress$1, nextProps.children), workInProgress$1.flags |= 4096);
			return workInProgress$1;
		}
		if (showFallback) return reuseSuspenseHandlerOnStack(workInProgress$1), showFallback = nextProps.fallback, nextInstance = workInProgress$1.mode, JSCompiler_temp$jscomp$0 = current.child, digest = JSCompiler_temp$jscomp$0.sibling, nextProps = createWorkInProgress(JSCompiler_temp$jscomp$0, {
			mode: "hidden",
			children: nextProps.children
		}), nextProps.subtreeFlags = JSCompiler_temp$jscomp$0.subtreeFlags & 65011712, null !== digest ? showFallback = createWorkInProgress(digest, showFallback) : (showFallback = createFiberFromFragment(showFallback, nextInstance, renderLanes$1, null), showFallback.flags |= 2), showFallback.return = workInProgress$1, nextProps.return = workInProgress$1, nextProps.sibling = showFallback, workInProgress$1.child = nextProps, nextProps = showFallback, showFallback = workInProgress$1.child, nextInstance = current.child.memoizedState, null === nextInstance ? nextInstance = mountSuspenseOffscreenState(renderLanes$1) : (JSCompiler_temp$jscomp$0 = nextInstance.cachePool, null !== JSCompiler_temp$jscomp$0 ? (digest = CacheContext._currentValue, JSCompiler_temp$jscomp$0 = JSCompiler_temp$jscomp$0.parent !== digest ? {
			parent: digest,
			pool: digest
		...
		switch (workInProgress$1.tag) {
			...
			case 3:
				a: {
					...
					lazyComponent !== prevState.cache && propagateContextChanges(workInProgress$1, [CacheContext], renderLanes$1, !0);
					suspendIfUpdateReadFromEntangledAsyncAction();
					...
					if (prevState.isDehydrated) if (prevState = {
						...
						workInProgress$1 = mountHostRootWithoutHydrating(current, workInProgress$1, lazyComponent, renderLanes$1);
						break a;
				...
				return workInProgress$1;
			case 26: return markRef(current, workInProgress$1), null === current ? (renderLanes$1 = getResource(workInProgress$1.type, null, workInProgress$1.pendingProps, null)) ? workInProgress$1.memoizedState = renderLanes$1 : isHydrating || (renderLanes$1 = workInProgress$1.type, current = workInProgress$1.pendingProps, lazyComponent = getOwnerDocumentFromRootContainer(rootInstanceStackCursor.current).createElement(renderLanes$1), lazyComponent[internalInstanceKey] = workInProgress$1, lazyComponent[internalPropsKey] = current, setInitialProperties(lazyComponent, renderLanes$1, current), markNodeAsHoistable(lazyComponent), workInProgress$1.stateNode = lazyComponent) : workInProgress$1.memoizedState = getResource(workInProgress$1.type, current.memoizedProps, workInProgress$1.pendingProps, current.memoizedState), null;
			case 27: return pushHostContext(workInProgress$1), null === current && isHydrating && (lazyComponent = workInProgress$1.stateNode = resolveSingletonInstance(workInProgress$1.type, workInProgress$1.pendingProps, rootInstanceStackCursor.current), hydrationParentFiber = workInProgress$1, rootOrSingletonContext = !0, init = nextHydratableInstance, isSingletonScope(workInProgress$1.type) ? (previousHydratableOnEnteringScopedSingleton = init, nextHydratableInstance = getNextHydratable(lazyComponent.firstChild)) : nextHydratableInstance = init), reconcileChildren(current, workInProgress$1, workInProgress$1.pendingProps.children, renderLanes$1), markRef(current, workInProgress$1), null === current && (workInProgress$1.flags |= 4194304), workInProgress$1.child;
			case 5:
				if (null === current && isHydrating) {
					if (init = lazyComponent = nextHydratableInstance) lazyComponent = canHydrateInstance(lazyComponent, workInProgress$1.type, workInProgress$1.pendingProps, rootOrSingletonContext), null !== lazyComponent ? (workInProgress$1.stateNode = lazyComponent, hydrationParentFiber = workInProgress$1, nextHydratableInstance = getNextHydratable(lazyComponent.firstChild), rootOrSingletonContext = !1, init = !0) : init = !1;
				...
				shouldSetTextContent(init, prevState) ? lazyComponent = null : null !== nextState && shouldSetTextContent(init, nextState) && (workInProgress$1.flags |= 32);
				null !== workInProgress$1.memoizedState && (init = renderWithHooks(current, workInProgress$1, TransitionAwareHostComponent, null, null, renderLanes$1), HostTransitionContext._currentValue = init);
				markRef(current, workInProgress$1);
				reconcileChildren(current, workInProgress$1, lazyComponent, renderLanes$1);
				return workInProgress$1.child;
			case 6:
		...
		switch (workInProgress$1.tag) {
			...
			case 5:
				...
				if (null !== current && null != workInProgress$1.stateNode) current.memoizedProps !== newProps && markUpdate(workInProgress$1);
					...
					current = contextStackCursor.current;
					if (popHydrationState(workInProgress$1)) prepareToHydrateHostInstance(workInProgress$1, current);
					else {
						type = getOwnerDocumentFromRootContainer(rootInstanceStackCursor.current);
						switch (current) {
							case 1:
								current = type.createElementNS("http://www.w3.org/2000/svg", renderLanes$1);
								break;
							case 2:
								current = type.createElementNS("http://www.w3.org/1998/Math/MathML", renderLanes$1);
								break;
							default: switch (renderLanes$1) {
								...
								case "select":
									...
									break;
								default: current = "string" === typeof newProps.is ? type.createElement(renderLanes$1, { is: newProps.is }) : type.createElement(renderLanes$1);
							}
						}
						current[internalInstanceKey] = workInProgress$1;
						current[internalPropsKey] = newProps;
						a: for (type = workInProgress$1.child; null !== type;) {
							...
							if (type === workInProgress$1) break a;
							for (; null === type.sibling;) {
								if (null === type.return || type.return === workInProgress$1) break a;
								type = type.return;
							}
			...
			case 19:
				pop(suspenseStackCursor);
				type = workInProgress$1.memoizedState;
				if (null === type) return bubbleProperties(workInProgress$1), null;
				...
				if (null === cache$127) if (newProps) cutOffTailIfNeeded(type, !1);
					...
					null !== type.tail && now() > workInProgressRootRenderTargetTime && (workInProgress$1.flags |= 128, newProps = !0, cutOffTailIfNeeded(type, !1), workInProgress$1.lanes = 4194304);
				}
				else {
					if (!newProps) if (current = findFirstSuspended(cache$127), null !== current) {
						if (workInProgress$1.flags |= 128, newProps = !0, current = current.updateQueue, workInProgress$1.updateQueue = current, scheduleRetryEffect(workInProgress$1, current), cutOffTailIfNeeded(type, !0), null === type.tail && "hidden" === type.tailMode && !cache$127.alternate && !isHydrating) return bubbleProperties(workInProgress$1), null;
					} else 2 * now() - type.renderingStartTime > workInProgressRootRenderTargetTime && 536870912 !== renderLanes$1 && (workInProgress$1.flags |= 128, newProps = !0, cutOffTailIfNeeded(type, !1), workInProgress$1.lanes = 4194304);
					type.isBackwards ? (cache$127.sibling = workInProgress$1.child, workInProgress$1.child = cache$127) : (current = type.last, null !== current ? current.sibling = cache$127 : workInProgress$1.child = cache$127, type.last = cache$127);
				}
				if (null !== type.tail) return workInProgress$1 = type.tail, type.rendering = workInProgress$1, type.tail = workInProgress$1.sibling, type.renderingStartTime = now(), workInProgress$1.sibling = null, current = suspenseStackCursor.current, push(suspenseStackCursor, newProps ? current & 1 | 2 : current & 1), workInProgress$1;
				bubbleProperties(workInProgress$1);
				return null;
			case 22:
	...
	function commitRootWhenReady(root$1, finishedWork, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, lanes, spawnedLane, updatedLanes, suspendedRetryLanes, didSkipSuspendedSiblings, exitStatus, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
		...
		if (suspendedCommitReason & 8192 || 16785408 === (suspendedCommitReason & 16785408)) {
			if (suspendedState = {
				...
				root$1.cancelPendingCommit = suspendedCommitReason(commitRoot.bind(null, root$1, finishedWork, lanes, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, spawnedLane, updatedLanes, suspendedRetryLanes, exitStatus, 1, completedRenderStartTime, completedRenderEndTime));
	...
	function renderRootConcurrent(root$1, lanes) {
		...
		a: do
			try {
				...
				handleThrow(root$1, thrownValue$169);
			}
		while (1);
		lastContextDependency = currentlyRenderingFiber$1 = null;
		ReactSharedInternals.H = prevDispatcher;
	...
	function flushSpawnedWork() {
		if (4 === pendingEffectsStatus || 3 === pendingEffectsStatus) {
			...
			0 !== (lanes & 4194090) && 0 !== (remainingLanes & 42) ? root$1 === rootWithNestedUpdates ? nestedUpdateCount++ : (nestedUpdateCount = 0, rootWithNestedUpdates = root$1) : nestedUpdateCount = 0;
	...
	function setInitialProperties(domElement, tag, props) {
		switch (tag) {
			...
			case "input":
				...
				var defaultValue$3 = propKey = propValue = hasSrcSet = null, checked = null, defaultChecked = null;
				...
				initInput(domElement, propKey, defaultValue$3, checked, defaultChecked, propValue, hasSrcSet, !1);
				track(domElement);
				return;
			case "select":
				listenToNonDelegatedEvent("invalid", domElement);
				hasSrc = propValue = propKey = null;
				for (hasSrcSet in props) if (props.hasOwnProperty(hasSrcSet) && (defaultValue$3 = props[hasSrcSet], null != defaultValue$3)) switch (hasSrcSet) {
					case "value":
						propKey = defaultValue$3;
						break;
					case "defaultValue":
						propValue = defaultValue$3;
						break;
					case "multiple": hasSrc = defaultValue$3;
					default: setProp(domElement, tag, hasSrcSet, defaultValue$3, props, null);
				}
				tag = propKey;
				props = propValue;
			...
			case "textarea":
				...
				for (propValue in props) if (props.hasOwnProperty(propValue) && (defaultValue$3 = props[propValue], null != defaultValue$3)) switch (propValue) {
					case "value":
						hasSrc = defaultValue$3;
						break;
					case "defaultValue":
						hasSrcSet = defaultValue$3;
						break;
					case "children":
						propKey = defaultValue$3;
						break;
					case "dangerouslySetInnerHTML":
						if (null != defaultValue$3) throw Error(formatProdErrorMessage(91));
						break;
					default: setProp(domElement, tag, propValue, defaultValue$3, props, null);
				}
		...
		for (defaultValue$3 in props) props.hasOwnProperty(defaultValue$3) && (hasSrc = props[defaultValue$3], null != hasSrc && setProp(domElement, tag, defaultValue$3, hasSrc, props, null));
	}
	function updateProperties(domElement, tag, lastProps, nextProps) {
		switch (tag) {
			...
			case "li": break;
			case "input":
				var name = null, type = null, value = null, defaultValue$3 = null, lastDefaultValue = null, checked = null, defaultChecked = null;
				...
				updateInput(domElement, value, defaultValue$3, lastDefaultValue, checked, defaultChecked, type, name);
				return;
			case "select":
				propKey = value = defaultValue$3 = propKey$205 = null;
			...
			case "textarea":
				...
				for (defaultValue$3 in lastProps) if (name = lastProps[defaultValue$3], lastProps.hasOwnProperty(defaultValue$3) && null != name && !nextProps.hasOwnProperty(defaultValue$3)) switch (defaultValue$3) {
					case "value": break;
					case "children": break;
					default: setProp(domElement, tag, defaultValue$3, null, nextProps, name);
				}
	...
	exports.createRoot = function(container, options$1) {
		...
		null !== options$1 && void 0 !== options$1 && (!0 === options$1.unstable_strictMode && (isStrictMode = !0), void 0 !== options$1.identifierPrefix && (identifierPrefix = options$1.identifierPrefix), void 0 !== options$1.onUncaughtError && (onUncaughtError = options$1.onUncaughtError), void 0 !== options$1.onCaughtError && (onCaughtError = options$1.onCaughtError), void 0 !== options$1.onRecoverableError && (onRecoverableError = options$1.onRecoverableError), void 0 !== options$1.unstable_transitionCallbacks && (transitionCallbacks = options$1.unstable_transitionCallbacks));
		options$1 = createFiberRoot(container, 1, !1, null, null, isStrictMode, identifierPrefix, onUncaughtError, onCaughtError, onRecoverableError, transitionCallbacks, null);
...
//#endregion
//#region node_modules/.pnpm/@dnd-kit+core@6.3.1_react-dom@19.1.1_react@19.1.1__react@19.1.1/node_modules/@dnd-kit/core/dist/core.esm.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_react_dom = /* @__PURE__ */ __toESM(require_react_dom());
const DndMonitorContext = /* @__PURE__ */ (0, import_react.createContext)(null);
...
function noop() {}
function useSensor(sensor, options$1) {
	return (0, import_react.useMemo)(() => ({
		sensor,
		options: options$1 != null ? options$1 : {}
	}), [sensor, options$1]);
}
function useSensors() {
...
*/
function getClientRect(element, options$1) {
	if (options$1 === void 0) options$1 = defaultOptions;
	let rect = element.getBoundingClientRect();
	if (options$1.ignoreTransform) {
...
function isScrollable(element, computedStyle) {
	...
	return properties$1.some((property) => {
...
var Listeners = class {
	...
	add(eventName, handler, options$1) {
		var _this$target2;
		(_this$target2 = this.target) == null || _this$target2.addEventListener(eventName, handler, options$1);
		this.listeners.push([
			eventName,
			handler,
			options$1
...
var KeyboardSensor = class {
	...
	handleKeyDown(event) {
		if (isKeyboardEvent(event)) {
			const { active, context, options: options$1 } = this.props;
			const { keyboardCodes = defaultKeyboardCodes, coordinateGetter = defaultKeyboardCoordinateGetter, scrollBehavior = "smooth" } = options$1;
			const { code } = event;
...
var TouchSensor = class extends AbstractPointerSensor {
	...
	static setup() {
		window.addEventListener(events$2.move.name, noop$5, {
			capture: false,
			passive: false
		});
		return function teardown() {
			window.removeEventListener(events$2.move.name, noop$5);
		};
		function noop$5() {}
	}
};
...
function useAutoScroller(_ref) {
	...
	(0, import_react.useEffect)(() => {
		...
		for (const scrollContainer of sortedScrollableAncestors) {
			...
			const index$1 = scrollableAncestors.indexOf(scrollContainer);
			const scrollContainerRect = scrollableAncestorRects[index$1];
...
function useMutationObserver(_ref) {
	...
	const mutationObserver = (0, import_react.useMemo)(() => {
		if (disabled || typeof window === "undefined" || typeof window.MutationObserver === "undefined") return void 0;
...
function useResizeObserver(_ref) {
	...
	const resizeObserver = (0, import_react.useMemo)(() => {
		if (disabled || typeof window === "undefined" || typeof window.ResizeObserver === "undefined") return void 0;
...
const InternalContext = /* @__PURE__ */ (0, import_react.createContext)(defaultInternalContext);
const PublicContext = /* @__PURE__ */ (0, import_react.createContext)(defaultPublicContext);
...
const ActiveDraggableContext = /* @__PURE__ */ (0, import_react.createContext)({
	...defaultCoordinates,
	scaleX: 1,
	scaleY: 1
});
...
const DndContext = /* @__PURE__ */ (0, import_react.memo)(function DndContext$1(_ref) {
	...
	const instantiateSensor = (0, import_react.useCallback)((event, _ref2) => {
		let { sensor: Sensor, options: options$1 } = _ref2;
			...
			return async function handler() {
				...
				if (active$1 && scrollAdjustedTranslate$1) {
					...
					if (type === Action.DragEnd && typeof cancelDrop === "function") {
						const shouldCancel = await Promise.resolve(cancelDrop(event$1));
...
const NullContext = /* @__PURE__ */ (0, import_react.createContext)(null);
...
function useDraggable(_ref) {
	...
	useIsomorphicLayoutEffect(() => {
		...
		return () => {
			...
			if (node$1 && node$1.key === key) draggableNodes.delete(id);
		};
	}, [draggableNodes, id]);
...
//#endregion
export { DndContext as b, PointerSensor as c, useDndContext as d, useDraggable as e, useSensor as f, useSensors as g, require_client as h };